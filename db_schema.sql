...
CREATE TABLE `llm_results` (
  ...
  `email_id` int NOT NULL,
  `summary` text,
  `intent` enum('scheduling','information_request','task_request','follow_up','meeting_confirmation','status_update','announcement','urgent','invoice','greeting','other') DEFAULT NULL,
  ...
  CONSTRAINT `llm_results_chk_1` CHECK ((`intent` in (_utf8mb4'scheduling',_utf8mb4'information_request',_utf8mb4'task_request',_utf8mb4'follow_up',_utf8mb4'meeting_confirmation',_utf8mb4'status_update',_utf8mb4'announcement',_utf8mb4'urgent',_utf8mb4'invoice',_utf8mb4'greeting',_utf8mb4'other')))
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-04-09  1:47:09
